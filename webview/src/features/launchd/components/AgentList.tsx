...
export function StatusDot({ state, title }: { state: LaunchAgentState; title?: string }) {
	return <span className={`size-2 shrink-0 rounded-full ring-1 ring-current ${stateClassNames[state]}`} title={title} />;
}
