	...
	return (
		<header className="mb-4.5 flex min-h-12 items-center justify-between gap-5 max-[760px]:items-start">
			<div className="flex min-w-0 items-center gap-3">
				<div className={`grid size-9 shrink-0 place-items-center rounded-[4px] bg-(--vscode-editorWidget-background) ring-1 ring-(--powerkit-border) ${accentClassName}`}>{icon}</div>
